...
<html>
    ...
    <body>
    	...
    	<h1><h:outputText value="#{LABEL_TITLE_CREDITAR_DEBITAR_CONTA}"/></h1>
    	<hr/>
		<h:form id="ContaForm">
    		<table>
    			<tr>
    				...
    				<td>
    					<h:inputText id="numeroConta" value="#{CreditarDebitarContaBean.numeroConta}"/>
    				</td>
    			</tr>
    			<tr>
    				<td><h:outputText value="#{Message.LABEL_FORM_VALOR}"/></td>
    				<td>
    					<h:inputText id="valor" value="#{CreditarDebitarContaBean.valor}"/>
    				</td>
    			</tr>   			
    		</table>
