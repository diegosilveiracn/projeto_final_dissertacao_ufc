...
<html>
    ...
    <body>
    	...
    	<h1><h:outputText value="#{Message.LABEL_TITLE_CONSULTAR_BONUS_CONTA}"/></h1>
    	<hr/>
		<h:form id="ContaForm">
    		<table>
    			<tr>
    				...
    				<td>
    					<h:inputText id="numeroConta" value="#{ConsultarBonusContaBean.numeroConta}" required="true">
    		...
    		<h:commandButton action="#{ConsultarBonusContaBean.consultarBonus}" value="#{Message.LABEL_BUTTON_CONSULTAR_BONUS}"/>
