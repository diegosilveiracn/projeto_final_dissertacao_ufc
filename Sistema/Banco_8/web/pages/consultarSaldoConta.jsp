...
<html>
    ...
    <body>
    	...
    	<h1><h:outputText value="#{Message.LABEL_TITLE_CONSULTAR_SALDO_CONTA}"/></h1>
    	<hr/>
		<h:form id="ContaForm">
    		<table>
    			<tr>
    				...
    				<td>
    					<h:inputText id="numeroConta" value="#{ConsultarSaldoContaBean.numeroConta}" required="true">
    		...
    		<h:commandButton action="#{ConsultarSaldoContaBean.consultarSaldo}" value="#{Message.LABEL_BUTTON_CONSULTAR_SALDO}"/>
