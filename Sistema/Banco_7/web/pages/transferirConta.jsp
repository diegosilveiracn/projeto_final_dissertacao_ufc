    	...
    	<h:form id="ContaForm">
    		<table>
    			<tr>
    				...
    				<td>
    					<h:inputText id="numeroContaOrigem" value="#{TransferirContaBean.numeroContaOrigem}" required="true">
							<f:validator validatorId="IntegerValidador"/>
    					</h:inputText>
    					<h:message for="numeroContaOrigem" style="color:red"/>
    				</td>
    			</tr>
    			<tr>
    				<td><h:outputText value="#{Message.LABEL_FORM_CONTA_DESTINO}"/><br/></td>
    				<td>
    					<h:inputText id="numeroContaDestino" value="#{TransferirContaBean.numeroContaDestino}" required="true">
							<f:validator validatorId="IntegerValidador"/>
    					</h:inputText>
						<h:message for="numeroContaDestino" style="color:red"/>
    				</td>    			
    			</tr>
    			<tr>
    				<td><h:outputText value="#{Message.LABEL_FORM_VALOR}"/><br/></td>
    				<td>
    					<h:inputText id="valor" value="#{TransferirContaBean.valor}" required="true">
